        ...
        <Box direction="Column" className={css.AuthCard}>
          ...
          <Box className={css.AuthCardContent} direction="Column">
            ...
            {discoveryState.status === AsyncStatus.Loading && (
              <AuthLayoutLoading message="Поиск сервера..." />
            )}
            {discoveryState.status === AsyncStatus.Error && (
              <AuthLayoutError message="Сервер не найден." />
            )}
            {autoDiscoveryError?.action === AutoDiscoveryAction.FAIL_PROMPT && (
              <AuthLayoutError
                message={`Не удалось подключиться. Конфигурация сервера ${autoDiscoveryError.host} недоступна.`}
              />
            )}
            {autoDiscoveryError?.action === AutoDiscoveryAction.FAIL_ERROR && (
              <AuthLayoutError message="Не удалось подключиться. Неверный адрес сервера." />
            )}
