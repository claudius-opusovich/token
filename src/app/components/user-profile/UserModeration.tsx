        ...
        <Box shrink="No" gap="200">
          {canInvite && (
            <Button
              ...
              disabled={disabled}
            >
              <Text size="B300">Пригласить</Text>
            </Button>
          )}
          {canKick && (
            <Button
