...
import { butterTheme, darkTheme, silverTheme, telegramDarkTheme } from '../../colors.css';
...
export const TelegramDarkTheme: Theme = {
  id: 'telegram-dark-theme',
  kind: ThemeKind.Dark,
  classNames: ['telegram-dark-theme', telegramDarkTheme, onDarkFontWeight, 'prism-dark'],
};

export const useThemes = (): Theme[] => {
  const themes: Theme[] = useMemo(() => [TelegramDarkTheme, DarkTheme, ButterTheme, LightTheme, SilverTheme], []);
...
export const useThemeNames = (): Record<string, string> =>
  useMemo(
    () => ({
      [TelegramDarkTheme.id]: 'Telegram Dark',
      [DarkTheme.id]: 'Dark',
