...
export const telegramDarkTheme = createTheme(color, {
  Background: {
    Container: '#0e1621',
    ContainerHover: '#131c27',
    ContainerActive: '#182533',
    ContainerLine: '#1d2d3d',
    OnContainer: '#e4ecf2',
  },

  Surface: {
    Container: '#17212b',
    ContainerHover: '#1c2936',
    ContainerActive: '#213040',
    ContainerLine: '#27384a',
    OnContainer: '#e4ecf2',
  },

  SurfaceVariant: {
    Container: '#182533',
    ContainerHover: '#1d2d3d',
    ContainerActive: '#233548',
    ContainerLine: '#2b3f53',
    OnContainer: '#e4ecf2',
  },
  ...
  Secondary: {
    ...
    OnMain: '#0e1621',
    Container: '#27384a',
    ContainerHover: '#2e4155',
    ContainerActive: '#354a60',
    ContainerLine: '#3c536b',
    OnContainer: '#e4ecf2',
  },
  ...
  Success: {
    ...
    OnMain: '#ffffff',
    Container: '#1a3a1a',
    ContainerHover: '#204520',
    ContainerActive: '#265026',
    ContainerLine: '#2c5b2c',
    OnContainer: '#c4ebc4',
  },
  ...
  Warning: {
    ...
    OnMain: '#1a1400',
    Container: '#3d2e10',
    ContainerHover: '#483614',
    ContainerActive: '#533e18',
    ContainerLine: '#5e461c',
    OnContainer: '#f0ddb0',
  },
  ...
  Critical: {
    ...
    OnMain: '#ffffff',
    Container: '#4a1a1a',
    ContainerHover: '#551f1f',
    ContainerActive: '#602424',
    ContainerLine: '#6b2929',
    OnContainer: '#f0c4c4',
  },
